...
const (
	...
	PingServiceName = "mergiate.v1.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/mergiate.v1.PingService/Ping"
)

// PingServiceClient is a client for the mergiate.v1.PingService service.
type PingServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewPingServiceClient constructs a client for the mergiate.v1.PingService service. By default, it
...
func NewPingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PingServiceClient {
	...
	pingServiceMethods := v1.File_mergiate_v1_ping_proto.Services().ByName("PingService").Methods()
...
// Ping calls mergiate.v1.PingService.Ping.
...
// PingServiceHandler is an implementation of the mergiate.v1.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/mergiate.v1.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mergiate.v1.PingService.Ping is not implemented"))
}
